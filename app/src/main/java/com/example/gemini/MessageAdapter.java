...
public class MessageAdapter extends  RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
    ...
    @Override    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View chatView = LayoutInflater.from(parent.getContext()).inflate(R.layout.send_item,null);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(message.getSentBy().equals(Message.SENT_BY_MY)){
    ...
    public int getItemCount() {
        if (messageList != null) {
            ...
            return 0; // or any default size depending on your logic
        }
    }
